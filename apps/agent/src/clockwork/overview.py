...
WORKFLOWS = [
    {
        "key": "sourcing",
        "name": "Sourcing",
        "blurb": "Finds contract work and scores it against your profile.",
        "tools": ["score_fit"],
        "action_types": [],
    },
    {
        "key": "pitch",
        "name": "Pitching",
        "blurb": "Writes outreach citing your own past results.",
        "tools": ["draft_pitch"],
    ...
    },
    {
        "key": "quote",
        "name": "Quoting",
        "blurb": "Prices work off your rate. Totals computed in code.",
    ...
    },
    {
        "key": "collections",
        "name": "Collections",
        "blurb": "Chases what is owed, escalating each time.",
        "tools": ["chase_payment"],
